    ...
    const fetchStocks = async () => {
      try {
        ...
        const fallbackStocks: Stock[] = [
          { symbol: 'SHEL', name: 'Shell PLC', price: 64.25, change: 1.2 },
          { symbol: 'TTE', name: 'TotalEnergies SE', price: 62.80, change: -0.5 },
          { symbol: 'BP', name: 'BP PLC', price: 35.45, change: 2.1 },
          { symbol: 'EQNR', name: 'Equinor ASA', price: 28.75, change: 0.8 }
        ];
