...
const defaultWidgets: Widget[] = [
  ...
  { id: 'world-map', type: 'world-map', title: 'GLOBAL ENERGY MAP', span: { col: 3, row: 1 }, activeLayers: ['geopolitical', 'weather'] },
  ...
  { id: 'opec', type: 'opec', title: 'OPEC+ MONITOR' },
  ...
  { id: 'crack-spread', type: 'crack-spread', title: 'CRACK SPREADS' },
  { id: 'global-lng', type: 'global-lng', title: 'GLOBAL LNG' },
  { id: 'carbon-credit', type: 'carbon-credit', title: 'CARBON CREDITS' },
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="h-[calc(100vh-115px)] relative">
        ...
        <div className="flex-1 bg-black min-h-0 overflow-y-auto" style={{ scrollbarWidth: 'thin', scrollbarColor: '#4a5568 #1a202c' }}>
          <DndContext 
            sensors={sensors}
          ...
          >
            ...
            >
              <div 
                className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 sm:gap-4 p-2 sm:p-4"
                style={{
          ...
          <div className="beta-warning-banner bg-red-600 border-t border-red-500 px-3 sm:px-6 py-2 w-full">
            <div className="flex items-center justify-center text-center">
              <div className="flex items-center gap-2 sm:gap-3">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2L1 21h22L12 2zm0 3.99L19.53 19H4.47L12 5.99zM11 16h2v2h-2v-2zm0-6h2v4h-2v-4z"/>
