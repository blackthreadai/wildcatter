 ...
 * Runs all calculations for an asset and returns a FinancialEstimate-like object.
 */
...
/**
 * Run all calculations for an asset given its metadata and production history.
 */
export function calculateAll(
  ...
  // Determine primary production column
  ...
  // Latest production for revenue/cost estimates
